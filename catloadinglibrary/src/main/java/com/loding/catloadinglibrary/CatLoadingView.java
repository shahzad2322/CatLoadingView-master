package com.loding.catloadinglibrary;
...
public class CatLoadingView extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        if (mDialog == null) {
            mDialog = new Dialog(getActivity(), com.loding.catloadinglibrary.R.style.cart_dialog);
            mDialog.setContentView(com.loding.catloadinglibrary.R.layout.catloading_main);
            ...
            mouse = view.findViewById(com.loding.catloadinglibrary.R.id.mouse);

            eye_left = view.findViewById(com.loding.catloadinglibrary.R.id.eye_left);

            eye_right = view.findViewById(com.loding.catloadinglibrary.R.id.eye_right);

            eyelid_left = (EyelidView) view.findViewById(com.loding.catloadinglibrary.R.id.eyelid_left);

            eyelid_left.setColor(Color.parseColor("#d0ced1"));

            eyelid_left.setFromFull(true);

            eyelid_right = (EyelidView) view.findViewById(com.loding.catloadinglibrary.R.id.eyelid_right);

            eyelid_right.setColor(Color.parseColor("#d0ced1"));

            eyelid_right.setFromFull(true);

            mGraduallyTextView = (GraduallyTextView) view.findViewById(com.loding.catloadinglibrary.R.id.graduallyTextView);
